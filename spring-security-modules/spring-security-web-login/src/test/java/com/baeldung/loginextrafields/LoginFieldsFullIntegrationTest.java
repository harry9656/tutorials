...
@Disabled("Check JIRA-29310")
class LoginFieldsFullIntegrationTest extends AbstractExtraLoginFieldsIntegrationTest {
    ...
    void givenAccessSecuredResource_whenAuthenticated_thenAuthHasExtraFields() throws Exception {
        ...
        mockMvc.perform(post(loginUrl).param("username", user.getUsername())
